...
if __name__ == "__main__":
    ...
    print "CSOVO Weighted Accuracy:", sum(cacc_l) / float(len(cacc_l))
    print "CSOVO Simple Accuracy:", sum(sacc_l) / float(len(sacc_l))
    print "CSOVO Mean Cost:", np.mean(scost_l)
    print "CSOVO Cost SD :", np.std(scost_l)
